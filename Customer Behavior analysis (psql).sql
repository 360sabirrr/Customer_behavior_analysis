...
-- Q2) whcih customer ued a discount but still spend more than the avg purchase  amount?
...
-- Q4) compare the average Purchasse Amounts between Standard and Express Shipping.
...
-- Q6) Which 5 products have the heigest percentage of purchases with discounts applied?
